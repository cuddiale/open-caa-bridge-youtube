...
L'estensione affianca una colonna fissa di pulsanti CAA interattivi e parlanti (sintesi vocale nativa in italiano) direttamente sul lato sinistro del vero sito originale di YouTube (`youtube.com`), consentendo un'esperienza multimediale autonoma e accessibile senza perdere l'interfaccia a cui l'utente è abituato.

## ✨ Caratteristiche
- **Layout Affiancato:** Ridimensiona automaticamente la pagina di YouTube per fare spazio a una barra laterale fissa (250px) sul lato sinistro che non scompare mai, nemmeno durante lo scorrimento.
...
Per usare le estensioni su Android è necessario **Kiwi Browser**. Puoi scaricarlo direttamente da qui:
👉 [Scarica Kiwi Browser per Android](https://kiwi-browser.en.uptodown.com/android)
